...
-----END PRIVATE KEY-----`,
  ...
  client_x509_cert_url: 'https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40jiwara-46f39.iam.gserviceaccount.com',
...
async function seedDatabase() {
  try {
    ...
    const agentPassword = await hashPassword('Agent@123456');
    ...
    // Create demo WhatsApp accounts
    await db.collection('whatsapp_accounts').add({
      businessAccountId: 'bus_123456789',
    ...
    console.log('✓ WhatsApp accounts created');
